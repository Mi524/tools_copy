...
class DataHandler(object):
	...
	def __init__(self, require_file_dir, input_dir, table_dict, *args,**kwargs):
		...
		# 创建默认的结果检查数据
		self.result_checking_dir = kwargs.get('result_checking_dir','.\\result_checking')
		check_create_new_folder(self.result_checking_dir)

		#创建处理数据类的
		self.handler = Handler(self.require_file_dir, self.input_dir, self.table_dict)
...
if __name__ == '__main__':
	...
	# config_file_dir = '.\\config_calc_amount(India) - OS calc step1'
	# config_file_dir = '.\\config_calc_amount(India) - OS calc step4'
	# config_file_dir = ".\\config_calc_amount(India) - OS calc step4 concat3"
